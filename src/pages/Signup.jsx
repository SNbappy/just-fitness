  ...
  return (
    <section className="min-h-[calc(100vh-64px)] grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-primary-700 via-primary-600 to-primary-800 text-white p-14 relative overflow-hidden">
        <div className="absolute -top-20 -left-16 w-72 h-72 rounded-full bg-secondary-500/100/25 blur-3xl animate-float" />
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        ...
        >
          <h1 className="text-2xl font-extrabold text-body">Create your account</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              <label className="text-sm font-semibold text-body">Full Name</label>
